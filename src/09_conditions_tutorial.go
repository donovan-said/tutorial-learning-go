...
func conditions_tutorial() {
	...
	*/
	...
	/*
		...
		false. Because of this, we move on to the else condition and print to
		the screen "Good evening". If the time was less than 18, the program
	...
	*/
	...
	/*
		...
		You can have if statements inside if statements, this is called a nested
		if.
